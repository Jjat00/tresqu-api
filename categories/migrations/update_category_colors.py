...
def update_category_colors(apps, schema_editor):
    """
    Actualiza los colores de las categorías existentes usando los colores predefinidos
    """
...
def reverse_update_category_colors(apps, schema_editor):
    """
...
class Migration(migrations.Migration):
    dependencies = [
        ('categories', '0001_initial'),  # Ajusta esto según tu última migración
    ]

    operations = [
        migrations.RunPython(update_category_colors,
                             reverse_update_category_colors),
    ]
